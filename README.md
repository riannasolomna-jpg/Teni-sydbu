...
Готовый full-stack сайт для Cloudflare Workers + D1 + R2.

## Что внутри
- `public/` — публичный сайт и админка;
- `worker.js` — API, авторизация администратора и работа с D1/R2;
...
- R2 binding: `IMAGE_BUCKET` → R2 bucket для изображений.
